...
def get_model():
    ...
    # Second convolutional layer. Learn 32 filters using a 2x2 kernel
    tf.keras.layers.Conv2D(
    ...
    # Third convolutional layer. Learn 48 filters using 2x2
    tf.keras.layers.Conv2D(
        48, (2, 2), activation="relu", input_shape=(IMG_WIDTH,IMG_HEIGHT,3)
    ),
